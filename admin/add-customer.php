...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Número de Móvil</label> <input type="text" class="form-control" id="mobilenum" name="mobilenum" placeholder="Número de Móvil" value="" required="true" maxlength="8" pattern="[0-9]{8}"> </div>
							 <div class="radio">
